...
class ApiService {
  ...
  public findPreference(id: number, waypoints: ICoordinate[], alpha: number[]) {
    return this.post(prefEndpoint + '/find', { id, waypoints, alpha });
  }

  public shortestPath(id: number, waypoints: ICoordinate[], alpha: number[]) {
